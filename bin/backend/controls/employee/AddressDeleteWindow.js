 ...
 */
define('package/quiqqer/employee/bin/backend/controls/employee/AddressDeleteWindow', [
    ...
    return new Class({
        ...
        initialize: function (options) {
            ...
            this.setAttributes({
                title      : QUILocale.get(lg, 'employee.address.delete.title'),
                text       : QUILocale.get(lg, 'employee.address.delete.text'),
                information: '',
        ...
        $onOpen: function () {
            ...
            QUIAjax.post('ajax_users_address_getAddressList', function (addresses) {
                ...
                self.setAttribute('information', QUILocale.get(lg, 'employee.address.delete.information', {
                    addressIds: list
                }));
