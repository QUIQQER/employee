 ...
 */
define('package/quiqqer/employee/bin/backend/controls/employee/Panel.UserFiles', [
    ...
    return new Class({
        ...
        Extends: QUIControl,
        Type   : 'package/quiqqer/employee/bin/backend/controls/employee/Panel.UserFiles',
        ...
        create: function () {
            ...
            this.$Grid = new Grid(Container, {
                buttons    : [{
                    name     : 'upload',
                    text     : QUILocale.get(lg, 'employee.files.upload.button'),
                    disabled : true,
        ...
        refresh: function () {
            ...
            this.getPermissions().then(function (permissions) {
                ...
                QUIAjax.get('package_quiqqer_employee_ajax_backend_files_getList', function (list) {
                    ...
                    employeeId: self.getAttribute('userId')
                });
            });
        },
        ...
        getPermissions: function () {
            ...
            return new Promise(function (resolve) {
                QUIAjax.get('package_quiqqer_employee_ajax_backend_files_getPermissions', function (permissions) {
        ...
        openUpload: function () {
            ...
            new QUIConfirm({
                title    : QUILocale.get(lg, 'window.employee.upload.title'),
                icon     : 'fa fa-upload',
                maxWidth : 600,
                maxHeight: 400,
                autoclose: false,
                events   : {
                    onOpen: function (Win) {
                        ...
                        require(['controls/upload/Form'], function (Form) {
                            ...
                            self.$Form.setParam('onfinish', 'package_quiqqer_employee_ajax_backend_files_upload');
                            self.$Form.setParam('package', 'quiqqer/employee');
                            self.$Form.setParam('employeeId', self.getAttribute('userId'));
        ...
        openDeleteDialog: function () {
            ...
            new QUIConfirm({
                ...
                title      : QUILocale.get(lg, 'window.employee.delete.title'),
                information: QUILocale.get(lg, 'window.employee.delete.information'),
                text       : QUILocale.get(lg, 'window.employee.delete.text'),
                maxWidth   : 600,
                maxHeight  : 400,
                autoclose  : false,
                events     : {
                    ...
                    onSubmit: function (Win) {
                        ...
                        QUIAjax.post('package_quiqqer_employee_ajax_backend_files_delete', function () {
                            Win.close();
                            self.refresh();
                        }, {
                            package   : 'quiqqer/employee',
